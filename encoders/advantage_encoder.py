    ...
    def forward(
        ...
        *,
        ...
        aux: Dict[str, torch.Tensor] = {
            "advantage_canvas_main_entry_mean": canvas[:, 4].mean(dim=(1, 2)),
            "advantage_canvas_nonmain_entry_mean": canvas[:, 5].mean(dim=(1, 2)),
            "advantage_canvas_revisit_mean": canvas[:, 3].mean(dim=(1, 2)),
        }
