...
def build_batch_plan(
    *,
    ...
    return {
        ...
        "a_new_parameter_status": "candidate_not_frozen",
        ...
        "notes": [
            ...
            "A_new training parameters are still candidate/tuning; the formal configuration is not yet frozen.",
            "After the A_new final candidate is reviewed and frozen, update TrainConfig or the relevant A_new runner defaults, then run this batch.",
